...
<article itemscope itemtype=http://schema.org/Article class="related-post">
					...
					<div class="related-post-image"> 
						...
						<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('full', array('itemprop' => 'thumbnailUrl', 'alt' => get_the_title() ) ); ?> </a>
					...
					<div class="related-post-content">
						...
						<h3 class="related-post-title" itemprop="headline name"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
						<div itemprop="articleBody" class="related-post-excerpt"><?php the_excerpt(); ?> <a href="<?php the_permalink(); ?>">[...]</a> </div>
